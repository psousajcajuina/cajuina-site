...
const handleAuth = async (request, env) => {
    ...
    const reqProvider = supportedProviders.includes(provider ?? "")
        ? provider
        : "unknown";
    ...
    const { ALLOWED_DOMAINS, GITHUB_CLIENT_ID, GITHUB_CLIENT_SECRET, GITHUB_HOSTNAME = "github.com", GITLAB_CLIENT_ID, GITLAB_CLIENT_SECRET, GITLAB_HOSTNAME = "gitlab.com", 
    //@ts-ignore
    BITBUCKET_CLIENT_ID, 
    //@ts-ignore
    BITBUCKET_CLIENT_SECRET, 
    //@ts-ignore
    BITBUCKET_HOSTNAME = "bitbucket.com", } = env;
    ...
    return new Response("", {
        ...
        headers: {
            ...
            "Set-Cookie": `csrf-token=${cookieProvider}_${csrfToken}; ` +
...
const handleCallback = async (request, env) => {
    ...
    const { GITHUB_CLIENT_ID, GITHUB_CLIENT_SECRET, GITHUB_HOSTNAME = "github.com", GITLAB_CLIENT_ID, GITLAB_CLIENT_SECRET, GITLAB_HOSTNAME = "gitlab.com", 
    //@ts-ignore
    BITBUCKET_CLIENT_ID, 
    //@ts-ignore
    BITBUCKET_CLIENT_SECRET, 
